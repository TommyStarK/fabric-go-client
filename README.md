...
[![GoDoc](https://godoc.org/github.com/TommyStarK/fabric-go-client?status.svg)](https://pkg.go.dev/github.com/TommyStarK/fabric-go-client@v1.1.0-hlf-1.4?tab=doc)
...
```bash
❯ go get github.com/TommyStarK/fabric-go-client@v1.1.0-hlf-1.4
```
